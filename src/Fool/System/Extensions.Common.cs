...
namespace Fool
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return Tools.Enum.GetValue(instance.GetType(), instance);
        }
        ...
        {
            return Tools.Convert.To<TResult>(Value(instance));
        }
        ...
        {
            return Tools.Enum.GetDescription(instance.GetType(), instance);
        }
        ...
        {
            return Tools.String.Join(list, quotes, separator);
        }
    }
}
