...
{    /// <summary>
    ...
    public static partial class Extensions
    {
        ...
        {
            return Tools.Convert.ToBool(obj);
        }
        ...
        {
            return Tools.Convert.ToBoolOrNull(obj);
        }
        ...
        {
            return Tools.Convert.ToInt(obj);
        }
        ...
        {
            return Tools.Convert.ToIntOrNull(obj);
        }
        ...
        {
            return Tools.Convert.ToLong(obj);
        }
        ...
        {
            return Tools.Convert.ToLongOrNull(obj);
        }
        ...
        {
            return Tools.Convert.ToDouble(obj);
        }
        ...
        {
            return Tools.Convert.ToDoubleOrNull(obj);
        }
        ...
        {
            return Tools.Convert.ToDecimal(obj);
        }
        ...
        {
            return Tools.Convert.ToDecimalOrNull(obj);
        }
        ...
        {
            return Tools.Convert.ToDate(obj);
        }
        ...
        {
            return Tools.Convert.ToDateOrNull(obj);
        }
        ...
        {
            return Tools.Convert.ToGuid(obj);
        }
        ...
        {
            return Tools.Convert.ToGuidOrNull(obj);
        }
        ...
        {
            return Tools.Convert.ToGuidList(obj);
        }
