using Fool.Security.Principals;
   ...
   public static class Web
    {
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static Fool.Webs.Clients.WebClient Client()
        {
            return new Fool.Webs.Clients.WebClient();
        }
        ...
        public static Fool.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class
        {
            return new Fool.Webs.Clients.WebClient<TResult>();
        }
