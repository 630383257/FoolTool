namespace Fool.Files {
    ...
    public struct FileSize {
        ...
        public double GetSizeByK() {
            return Fool.Tools.Convert.ToDouble( _size / 1024.0, 2 );
        }
        ...
        public double GetSizeByM() {
            return Fool.Tools.Convert.ToDouble( _size / 1024.0 / 1024.0, 2 );
        }
        ...
        public double GetSizeByG() {
            return Fool.Tools.Convert.ToDouble( _size / 1024.0 / 1024.0 / 1024.0, 2 );
        }
